...
class PostOtherLabelsAPITestCase(BasePopitAPITestCase):
...
class PostContactDetailsAPITestCase(BasePopitAPITestCase):
...
class PostListAPITestCase(BasePopitAPITestCase):
