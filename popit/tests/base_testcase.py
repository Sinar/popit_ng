...
class BasePopitTestCase(TestCase):
    ...
    def setUp(self):
        ...
        post_save.disconnect(entity_save_handler, sender=Area)
        ...
        pre_delete.disconnect(entity_prepare_delete_handler, sender=Area)
        ...
        post_delete.disconnect(entity_perform_delete_handler, sender=Area)
...
class BasePopitAPITestCase(APITestCase):
    fixtures = ["api_request_test_data.yaml"]
