...
class MembershipSerializer(BasePopitSerializer):
    ...
    organization_id = CharField(max_length=255, allow_null=True, required=False)
    member = MembershipOrganizationSerializer(required=False)
    member_id = CharField(max_length=255, allow_null=True, required=False)
    on_behalf_of = MembershipOrganizationSerializer(required=False)
    on_behalf_of_id = CharField(max_length=255, allow_null=True, required=False)
    area = AreaSerializer(required=False)
    area_id = CharField(max_length=255, allow_null=True, required=False)
