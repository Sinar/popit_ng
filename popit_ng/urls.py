...
api_urls = [
    ...
    url(r'^(?P<language>\w{2})/posts/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/(?P<link_id>\w+)/?$',
        PostContactDetailCitationDetailView.as_view(), name="post-contact-detail-citation-detail-view"),
    url(r'^(?P<language>\w{2})/posts/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/?$',
        PostContactDetailCitationListView.as_view(), name="post-contact-detail-citation-list-views"),
    url(r'^(?P<language>\w{2})/posts/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/?$',
    ...
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/(?P<link_id>[-\w]+)/?$',
        PersonContactDetailCitationDetailView.as_view(), name="person-contact-details-citations-detail-view"),
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/?$',
        PersonContactDetailCitationListView.as_view(), name="person-contact-details-citations-view"),
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/?$',
    ...
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/othernames/(?P<pk>[-\w]+)/citations/(?P<field>[-\w]+)/(?P<link_id>[-\w]+)/?$',
        PersonOthernameCitationDetailView.as_view(), name="person-othername-citation-detail-view"),
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/othernames/(?P<pk>[-\w]+)/citations/(?P<field>[-\w]+)/?$',
        PersonOthernameCitationListView, name="person-othername-citation-list-view"),
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/othernames/(?P<pk>[-\w]+)/citations/?$',
    ...
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/identifiers/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/(?P<link_id>[-\w]+)/?$',
        PersonIdentifierCitationDetailView.as_view(), name="person-identifier-citation-detail"),
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/identifiers/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/?$',
        PersonIdentifierCitationListView.as_view(), name="person-identifier-citation-list"),
    url(r'^(?P<language>\w{2})/persons/(?P<parent_pk>[-\w]+)/identifiers/(?P<pk>[-\w]+)/citations/?$',
    ...
    url(r'^(?P<language>\w{2})/organizations/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/(?P<field>\w+)/?$',
        OrganizationContactDetailCitationListView.as_view(), name="organization-contact-details-citation-views"),
    url(r'^(?P<language>\w{2})/organizations/(?P<parent_pk>[-\w]+)/contact_details/(?P<pk>[-\w]+)/citations/?$',
